...
open class CandleViewBase: AKView, ADataProvider, AnimatorDelegate
{
    ...
    internal var _defaultValueFormatter: AValueFormatter? = DefaultValue(decimals: 0)
    
    /// object that holds all data that was originally set for the chart, before it was modified or any filtering algorithms had been applied
    internal var _data: AData?
    ...
    open var descriptionTextColor: Color?
        {
    ...
    internal func setupDefaultFormatter(min: Double, max: Double)
    {
        ...
        if _defaultValueFormatter is DefaultValue
        {
            // setup the formatter with a new number of digits
            let digits = AUtils.decimals(reference)
            
            (_defaultValueFormatter as? DefaultValue)?.decimals
                = digits
        }
    }
    ...
    open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingX: AEasingFunctionBlock?, easingY: AEasingFunctionBlock?)
    {
    ...
    open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingOptionX: AEasingOption, easingOptionY: AEasingOption)
    {
    ...
    open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easing: AEasingFunctionBlock?)
    {
    ...
    open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingOption: AEasingOption)
    {
    ...
    /// - parameter xAxisDuration: duration for animating the x axis
    /// - parameter easing: an easing function for the animation
    open func animate(xAxisDuration: TimeInterval, easing: AEasingFunctionBlock?)
    {
    ...
    /// - parameter xAxisDuration: duration for animating the x axis
    /// - parameter easingOption: the easing function for the animation
    open func animate(xAxisDuration: TimeInterval, easingOption: AEasingOption)
    {
    ...
    /// - parameter yAxisDuration: duration for animating the y axis
    /// - parameter easing: an easing function for the animation
    open func animate(yAxisDuration: TimeInterval, easing: AEasingFunctionBlock?)
    {
    ...
    /// - parameter yAxisDuration: duration for animating the y axis
    /// - parameter easingOption: the easing function for the animation
    open func animate(yAxisDuration: TimeInterval, easingOption: AEasingOption)
    {
