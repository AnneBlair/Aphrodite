...
/// ChartBaseDataSet
open class ABaseDataSet: NSObject, ADataSet
{
    public required override init()
    {
        ...
        valueColors.append(Color.black)
    }
    ...
    open func entryForIndex(_ i: Int) -> ADataEntry?
    {
    ...
    open func entryForXValue(
        _ x: Double,
        closestToY y: Double) -> ADataEntry?
    {
        fatalError("entryForXValue(x, closestToY) is not implemented in ChartBaseDataSet")
    }
    
    open func entriesForXValue(_ x: Double) -> [ADataEntry]
    {
    ...
    open func entryIndex(entry e: ADataEntry) -> Int
    {
        fatalError("entryIndex(entry) is not implemented in ChartBaseDataSet")
    }
    
    open func addEntry(_ e: ADataEntry) -> Bool
    {
        fatalError("addEntry is not implemented in ChartBaseDataSet")
    }
    
    open func addEntryOrdered(_ e: ADataEntry) -> Bool
    {
        fatalError("addEntryOrdered is not implemented in ChartBaseDataSet")
    }
    
    @discardableResult open func removeEntry(_ entry: ADataEntry) -> Bool
    {
    ...
    open func contains(_ e: ADataEntry) -> Bool
    {
        fatalError("removeEntry is not implemented in ChartBaseDataSet")
    }
    ...
    internal var _valueFormatter: AValueFormatter?
    
    /// Custom formatter that is used instead of the auto-formatter if set
    open var valueFormatter: AValueFormatter?
        {
        get
        {
            if needsFormatter
            {
                return AUtils.defaultValueFormatter()
            }
