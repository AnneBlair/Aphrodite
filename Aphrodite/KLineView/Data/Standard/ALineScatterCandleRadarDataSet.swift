//
//  ALineScatterCandleRadarDataSet.swift
//  Aphrodite
//
...
open class ALineScatterCandleRadarDataSet: BarLineScatterCandleBubbleDataSet, ALineScatterDataSet
{
    ...
    {
        let copy = super.copyWithZone(zone) as! ALineScatterDataSet
