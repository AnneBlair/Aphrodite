...
open class AData: NSObject {
    ...
    internal var _dataSets = [ADataSet]()
    ...
    public init(dataSets: [ADataSet]?) {
        super.init()
        
        _dataSets = dataSets ?? [ADataSet]()
        
        self.initialize(dataSets: _dataSets)
    }
    
    public convenience init(dataSet: ADataSet?) {
        self.init(dataSets: dataSet === nil ? nil : [dataSet!])
    }
    
    internal func initialize(dataSets: [ADataSet]) {
        notifyDataChanged()
    }
    ...
    open func calcMinMax(entry e: ADataEntry, axis: YAxis.AxisDependency)
    {
        if _yMax < e.y
        {
            _yMax = e.y
    ...
    open func calcMinMax(dataSet d: ADataSet)
    {
        if _yMax < d.yMax
        {
            _yMax = d.yMax
    ...
    open func entryForHighlight(_ highlight: Highlight) -> ADataEntry?
    {
    ...
    open func getDataSetByLabel(_ label: String, ignorecase: Bool) -> ADataSet?
    {
    ...
    open func getDataSetByIndex(_ index: Int) -> ADataSet!
    {
        if index < 0 || index >= _dataSets.count
        {
            return nil
    ...
    open func addDataSet(_ dataSet: ADataSet!)
    {
    ...
    @discardableResult open func removeDataSet(_ dataSet: ADataSet!) -> Bool
    {
        if dataSet === nil
        {
            return false
    ...
    open func addEntry(_ e: ADataEntry, dataSetIndex: Int)
    {
    ...
    @discardableResult open func removeEntry(_ entry: ADataEntry, dataSetIndex: Int) -> Bool
    {
        // entry outofbounds
    ...
    open func getDataSetForEntry(_ e: ADataEntry!) -> ADataSet?
    {
        if e == nil
        {
            return nil
    ...
    open func indexOfDataSet(_ dataSet: ADataSet) -> Int
    {
        for i in 0 ..< _dataSets.count
        {
            if _dataSets[i] === dataSet
    ...
    open func getFirstLeft(dataSets: [ADataSet]) -> ADataSet?
    {
    ...
    open func getFirstRight(dataSets: [ADataSet]) -> ADataSet?
    {
        for dataSet in _dataSets
        {
            if dataSet.axisDependency == .right
    ...
    open func setValueFormatter(_ formatter: AValueFormatter?)
    {
    ...
    open func contains(dataSet: ADataSet) -> Bool
    {
        for set in dataSets
        {
            if set === dataSet
    ...
    open var maxEntryCountSet: ADataSet?
    {
