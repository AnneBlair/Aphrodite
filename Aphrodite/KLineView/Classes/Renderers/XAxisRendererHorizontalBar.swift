//
//  XAxisRendererHorizontalBar.swift
//  Aphrodite
//
...
open class XAxisRendererHorizontalBar: XAxisRenderer
{
    internal var chart: ABarView?
    
    public init(viewPortHandler: PortHandler?, xAxis: XAxis?, transformer: Transformer?, chart: ABarView?)
    {
    ...
    open override func computeSize()
    {
        ...
        let labelRotatedSize = AUtils.sizeOfRotatedRectangle(rectangleWidth: labelSize.width, rectangleHeight:  labelHeight, degrees: xAxis.labelRotationAngle)
