...
open class HorizontalBarRenderer: ABarRenderer
{
    ...
    public override init(dataProvider: ABarDataProvider?, animator: Animator?, viewPortHandler: PortHandler?)
    {
    ...
    open override func drawDataSet(context: CGContext, dataSet: AIBarDataSet, index: Int)
    {
        guard let
            dataProvider = dataProvider,
    ...
    open override func isDrawingValuesAllowed(dataProvider: ADataProvider?) -> Bool
    {
