//
//  YAxisRendererHorizontalBar.swift
//  Aphrodite
//
...
open class YAxisRendererHorizontalBar: YAxisRenderer
{
    public override init(viewPortHandler: PortHandler?, yAxis: YAxis?, transformer: Transformer?)
    {
