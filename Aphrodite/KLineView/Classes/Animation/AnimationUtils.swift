...
public typealias AEasingFunctionBlock = ((_ elapsed: TimeInterval, _ duration: TimeInterval) -> Double)

internal func easingFunctionFromOption(_ easing: AEasingOption) -> AEasingFunctionBlock {
    switch easing {
    case .linear:
