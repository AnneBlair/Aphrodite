...
open class HorizontalBarView: ABarView
{
    internal override func initialize()
    {
        ...
        _leftAxisTransformer = TransformerHorizontalBar(viewPortHandler: _viewPortHandler)
        _rightAxisTransformer = TransformerHorizontalBar(viewPortHandler: _viewPortHandler)
        
        renderer = HorizontalBarRenderer(dataProvider: self, animator: _animator, viewPortHandler: _viewPortHandler)
        _leftYAxisRenderer = YAxisRendererHorizontalBar(viewPortHandler: _viewPortHandler, yAxis: _leftAxis, transformer: _leftAxisTransformer)
        _rightYAxisRenderer = YAxisRendererHorizontalBar(viewPortHandler: _viewPortHandler, yAxis: _rightAxis, transformer: _rightAxisTransformer)
        _xAxisRenderer = XAxisRendererHorizontalBar(viewPortHandler: _viewPortHandler, xAxis: _xAxis, transformer: _leftAxisTransformer, chart: self)
        
        self.highlighter = AHorizontalHighlighter(chart: self)
    }
    ...
    open override func getBarBounds(entry e: ABarDataEntry) -> CGRect
    {
        guard
    ...
    open override func getPosition(entry e: ADataEntry, axis: YAxis.AxisDependency) -> CGPoint
    {
