...
/// ChartHighlighter
open class CandleHighlighter : NSObject, AHighlighter
{
    /// instance of the data-provider
    open weak var chart: ADataProvider?
    
    public init(chart: ADataProvider)
    {
        self.chart = chart
    }
